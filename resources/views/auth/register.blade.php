    ...
    <div class="w-4/12 bg-white p-6 rounded-lg">
        <form action="{{ route('register') }}" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="username" name="username" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('username') border-red-500 @enderror" placeholder="Your username" value="{{ old('username') }}">
                @error('username')
                <p class="text-red-500 mt-2 text-sm">
                    {{ $message }}
                </p>
            ...
            <div class="mb-4">
                ...
                <input type="password" id="password" name="password" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password') border-red-500 @enderror" placeholder="Choose a password">
                @error('password')
                <p class="text-red-500 mt-2 text-sm">
                    {{ $message }}
                </p>
